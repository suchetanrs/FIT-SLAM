...
public:
    PointCloudTransformer() : Node("unique_pcl_transformer")
    {
        ...
        subscription_map_data_ = this->create_subscription<slam_msgs::msg::MapData>(
            "map_data", 10,
...
private:
    ...
    void mapDataCallback(const slam_msgs::msg::MapData::SharedPtr map_msg)
    {        
    ...
    rclcpp::Subscription<slam_msgs::msg::MapData>::SharedPtr subscription_map_data_;
